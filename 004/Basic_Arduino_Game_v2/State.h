...
typedef struct State_struct (*ModeFn)(struct State_struct current_state, unsigned long current_time, bool start_button_reading, bool fire_button1_reading, bool fire_button2_reading);
