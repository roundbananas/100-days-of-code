...
{
  private:
  //the following variables are setup for a single digit display
  byte m_numDigits = 1; //sets the number of digits on your display
  ...
  byte m_hardwareConfig = COMMON_ANODE; // See README.md for options
