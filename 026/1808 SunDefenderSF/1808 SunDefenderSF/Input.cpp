            ...
            if(mode == GameMode::PLAYING)
            {
                if (event.key.code == Keyboard::Num1)
                {
                    if(((t - player[0].getLastFired()) > 1/player[0].getFireRate()) && player[0].getCharged())
                    {
                        ...
                        canon0Projectiles[m_currentProjectileCanon0].shoot(0, m_canonArrayDigital);
                        std::cout <<"\n\nCurrent Projectile on 1: " << m_currentProjectileCanon0;
                ...
                if (event.key.code == Keyboard::Num2)
                {
                    if(((t - player[1].getLastFired()) > 1/player[1].getFireRate()) && player[1].getCharged())
                    {
                        ...
                        canon1Projectiles[m_currentProjectileCanon1].shoot(1, m_canonArrayDigital);
                ...
                if (event.key.code == Keyboard::Num3)
                {
                    if(((t - player[2].getLastFired()) > 1/player[2].getFireRate()) && player[2].getCharged())
                    {
                        ...
                        canon2Projectiles[m_currentProjectileCanon2].shoot(2, m_canonArrayDigital);
                ...
                if (event.key.code == Keyboard::Num4)
                {
                    if(((t - player[3].getLastFired()) > 1/player[3].getFireRate()) && player[3].getCharged())
                    {
                        ...
                        canon3Projectiles[m_currentProjectileCanon3].shoot(3, m_canonArrayDigital);
                ...
                if (event.key.code == Keyboard::Num5)
                {
                    if(((t - player[4].getLastFired()) > 1/player[4].getFireRate()) && player[4].getCharged())
                    {
                        ...
                        canon4Projectiles[m_currentProjectileCanon4].shoot(4, m_canonArrayDigital);
