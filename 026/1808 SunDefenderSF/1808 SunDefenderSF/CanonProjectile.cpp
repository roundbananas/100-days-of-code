...
void CanonProjectile::shoot(int canonNumber, VertexArray& canonVA)
{
    ...
    switch(canonNumber)
    {
        case 0: //first canon
            ...
            m_TargetPosition = Vector2f(204, 700); 
            break;
        case 1:
            m_StartPosition = canonVA[1].position;
            m_TargetPosition = Vector2f(336, 700);
            break;
        case 2:
            m_StartPosition = canonVA[2].position;
            m_TargetPosition = Vector2f(460, 700);
            break;
        case 3:
            m_StartPosition = canonVA[3].position;
            m_TargetPosition = Vector2f(589, 700);
            break;
        case 4:
            m_StartPosition = canonVA[4].position;
            m_TargetPosition = Vector2f(716, 700);
            break;
    }
    ...
    m_InFlight = true;
     ...
     std::cout <<"\nProj 1 Position: " << m_position.x << " . " << m_position.y;
    std::cout <<"\nProj 1 flight: " << m_InFlight;
        /*
