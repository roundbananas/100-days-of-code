...
public:
    ...
    //Pure virtual function. Having this in the class makes it an Abstract Class and it cannot be instantiated.
    //This is because we don't want to instantiate a plain "Playable Character". We want to use Playable Character type to create several unique characters that we do want to instantiate.
