...
void Player::update(float elapsedTime, Vector2i mousePosition)
{
    ...
    float angle = (atan2(mousePosition.y - m_Resolution.y/2, mousePosition.x - m_Resolution.x/2) * 180)/3.141; //this formula doesn't account for the quadrant the mouse is in nor the sign of the ratio of dy/dx.
