        ...
        if(event.type == Event::KeyPressed)
        {
            ...
            if(mode == GameMode::PLAYING)
            {
                if (event.key.code == Keyboard::Num1)
                {
                    ...
                    //NEED TO UPDATE HOW I"VE DONE THE PROJECTILES, SO I CAN SPAWN THEM HERE. OTHERWISE THEY ONLY SPAWN ONCE
                    
                    projectiles[0].shoot(); //sets projectile m_InFlight = true
                }
