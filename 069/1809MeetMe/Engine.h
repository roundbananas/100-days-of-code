...
class Engine
{
  ...
  bool m_GameOverFlag = false;
    ...
    int m_firstButtonPin = 13; //we'll use digital pins and digitalRead() for these.
    int m_FirstBoostPin = 6;
    ...
    int m_PlayerBoostLedPins[3] = {3, 4, 5}; //ANALOG PINS. We'll use digitalWrite to write to them
    long m_PlayerBoostLedOnDurations[3] = {100,100,100}; //make these flash faster for an exciting effect! haha
    ...
    int m_stripDataPinArray[m_NumPlayers] = {19, 21, 23};
    int m_stripClockPinArray[m_NumPlayers] = {20, 22, 24};
    ...
    byte m_CurrentRound_DigitPins[2] = {36, 37};
    ...
    byte m_BestRounds_DigitPins[2] = {45, 46};
