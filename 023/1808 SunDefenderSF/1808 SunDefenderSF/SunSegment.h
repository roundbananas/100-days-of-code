...
private:
    ...
    double m_SunLife = 2000.0;           //in 'units'
    double m_EnemyLaserEffect = 1;  //in 'units per second'
    double m_TotalTimeSunHasBeenLasered = 0.0;    //for how many seconds has the sun has been lasered so far?
