        ...
        if(event.type == Event::KeyPressed)
        {
            ...
            if((mode == GameMode::IDLE || mode == GameMode::GAME_OVER) && ((event.key.code == Keyboard::Num1) || (event.key.code == Keyboard::Num2) || (event.key.code == Keyboard::Num3) || (event.key.code == Keyboard::Num4)|| (event.key.code == Keyboard::Num5)))
            {
                ...
                *******/
                ...
                //Delete any existing instances of player, enemies, lasers
                delete[] enemies;
                delete[] player;
                delete[] enemyLasers;
                //???do I need to delete the sun? how?
                
                //Spawn player, enemies and lasers, sun
            ...
            }//END handle player starting the game
