...
//HELPERS
SensorFn Engine::updateSensor1() 		//define updateSensor1, a function that returns void
{ 
	Serial.println(m_SensorStates[0]);
    m_SensorStates[0] = !m_SensorStates[0]; 
    Serial.println(m_SensorStates[0]);
} 

SensorFn Engine::updateSensor2() 
{
	Serial.println("S2 B4");
	Serial.println(m_SensorStates[1]);
    m_SensorStates[1] = !m_SensorStates[1];
    Serial.println(m_SensorStates[1]);
    Serial.println("S2 After");
} 

SensorFn Engine::updateSensor3() 
{
