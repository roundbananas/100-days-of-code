...
/******** GAME OBJECTS *********/
	...
	/* HEPLERS */
		...
		SensorFn m_updateHallSensors[m_NumSensors] = {updateSensor1(),updateSensor2(), updateSensor3()};

		void CreateSensors(int numSensors, byte sensorPins[], SensorFn updateSensors[]);
