...
attachPCINT(digitalPinToPCINT(getSensorPin(0)), interruptDispatch1, CHANGE);
attachPCINT(digitalPinToPCINT(getSensorPin(1)), interruptDispatch2, CHANGE);
attachPCINT(digitalPinToPCINT(getSensorPin(2)), interruptDispatch3, CHANGE);
  ...
  m_OledDisplay->sendBuffer();          // transfer internal memory to the display
	...
	//CreateSensors(m_NumSensors, m_SensorPins, m_updateHallSensors);
