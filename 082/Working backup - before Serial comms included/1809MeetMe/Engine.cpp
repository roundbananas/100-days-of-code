...
/*
     ...
     m_BestRoundsDisplay.begin(m_BestRounds_HardwareConfig, m_BestRounds_NumDigits, m_BestRounds_DigitPins, m_CurrentRound_7SegPins, m_ResistorsOnSegments, m_UpdateWithDelays, m_LeadingZeros);
