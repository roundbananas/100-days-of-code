 ...
 * Displays
 */
//declare a seven segment display
SevSeg display1;
  ...
  byte display1_digitPins[] = {12, 11, 10, 9};
  byte display1_segmentPins[8] = {8, 7, 6, 5, 4, A5, 2, 1}; //NOTE pin 1 is not connected. We don't need DP.
