...
void Bullet::updateBullet(unsigned long t, int num_Pixels)
{
  //
  //update the head and tail using equation of motion
  //if the head has reached the end of the strip, toggle a variable to signify to the engine to change management of bullets
  //  keep incrementing the tail until it is also off the en
