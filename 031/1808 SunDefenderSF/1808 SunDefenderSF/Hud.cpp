...
Hud::Hud()
{
    ...
    m_HowToPlayInstructions.setCharacterSize(40);
    ...
    m_HowToPlayInstructions.setPosition(resolution.x/2.0f, 7 * resolution.y/10.0f);
 ...
 //   m_LevelUpText.setString("LEVEL UP TEXT");
    ...
    levelUpStream <<
    "You beat the first wave!" <<
    "\n\nChoose an Upgrade: " <<
    "\n1- Increased rate of fire" <<
    "\n2- Increased damage inflicted";
