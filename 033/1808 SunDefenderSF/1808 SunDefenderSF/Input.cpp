...
void Engine::m_Input(double t)
{
    ...
    while(m_Window.pollEvent(event))
    {
        if(event.type == Event::KeyPressed)
        {
            ...
            if((mode == GameMode::IDLE || mode == GameMode::GAME_OVER) && (event.key.code == Keyboard::Return))
            {
                /******
                ...
                m_SM.stopBGMenuMusic();
                m_SM.playBGPlayingMusic();
            }
            ...
            if(mode == GameMode::PLAYING)
            {
                if (event.key.code == Keyboard::Num1)
                {
                    ...
                    if(!player[0].getCharged())
                    {
                        m_SM.playNotCharged();
                    }
                    else if(((t - player[0].getLastFired()) > 1/player[0].getFireRate()) && player[0].getCharged())
                    {
                ...
                {
                    //play not recharged sound
                    if(!player[1].getCharged())
                    {
                        m_SM.playNotCharged();
                    }
                    else if(((t - player[1].getLastFired()) > 1/player[1].getFireRate()) && player[1].getCharged())
                    {
                ...
                {
                    //play not recharged sound
                    if(!player[2].getCharged())
                    {
                        m_SM.playNotCharged();
                    }
                    else if(((t - player[2].getLastFired()) > 1/player[2].getFireRate()) && player[2].getCharged())
                    {
                ...
                {
                    //play not recharged sound
                    if(!player[3].getCharged())
                    {
                        m_SM.playNotCharged();
                    }
                    else if(((t - player[3].getLastFired()) > 1/player[3].getFireRate()) && player[3].getCharged())
                    {
                ...
                {
                    //play not recharged sound
                    if(!player[4].getCharged())
                    {
                        m_SM.playNotCharged();
                    }
                    else if(((t - player[4].getLastFired()) > 1/player[4].getFireRate()) && player[4].getCharged())
                    {
